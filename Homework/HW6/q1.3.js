...
let p3 = new Vector_array([2, 3]),
    p4 = new Vector_array([1, 2])
console.log(p3)
console.log(p3.toString())
console.log(p3 + '')
console.log('p3.length()=', p3.length())
console.log('p3.sub(p4)=', p3.sub(p4))
console.log('p3.dot(p4)=', p3.dot(p4))
console.log('p3.sub(p4).length()=', p3.sub(p4).length())
console.log('p3.distance(p4)=', p3.distance(p4))